...
struct Gizmo
{
    ...
    public:
        ...
        void initialize()
        {
            ...
            prim->createTrianglePlane("central",0.5f,0.5f,1,1,mc::Direction::up());
        }
...
//                prim->draw("arrow_head");
            ...
            m_model.identity();
                ...
                auto phi = mc::toRads(90.f) + atan2(rotationAxis.dot(direction.cross(shadow)) , direction.dot(shadow));
